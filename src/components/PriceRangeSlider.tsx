    ...
    <div className={clsx('relative flex flex-col gap-y-6', className)}>
      ...
      <div className="flex justify-between gap-x-5">
        <div className="flex-1">
          <div className="ps-4 text-xs/6 text-neutral-700 dark:text-neutral-300">Min fiyat</div>
        ...
        <div className="flex-1">
          <div className="ps-4 text-xs/6 text-neutral-700 dark:text-neutral-300">Max fiyat</div>
          <div className="relative mt-0.5 w-full rounded-full bg-neutral-100 px-4 py-2 text-sm dark:bg-neutral-800">
