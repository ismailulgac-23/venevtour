...
const ExperienceSearchFormMobile = () => {
  ...
  const handleFormSubmit = (formData: FormData) => {
    ...
    const count = (guestInput.guestAdults || 0) + (guestInput.guestChildren || 0)
    if (count > 0) params.append('guestCount', count.toString())
  ...
  const totalGuests = (guestInput.guestAdults || 0) + (guestInput.guestChildren || 0)
  ...
  return (
    ...
    >
      ...
      <FieldPanelContainer
        ...
        headingTitle="Nereye?"
        headingValue={locationInputTo || 'Destinasyon seçin'}
      >
        <LocationInput
      ...
      <FieldPanelContainer
        ...
        headingTitle="Ne zaman?"
        headingValue={startDate ? converSelectedDateToString([startDate, endDate]) : 'Tarih ekleyin'}
      >
