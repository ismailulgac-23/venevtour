...
const SidebarNavigation: React.FC<Props> = ({ data, currencies, languages }) => {
  ...
  return (
    <div>
      <span className="text-sm text-neutral-500 font-medium">Hayalinizdeki turu keşfedin, benzersiz deneyimlere adım atın ve anılarınızı paylaşın.</span>
      ...
      <div className="flex items-center justify-between gap-x-2.5 py-6">
        <ButtonPrimary
          href="/tours"
          className="text-sm font-bold px-6 h-12 rounded-2xl"
        >
          Turları Keşfet
        </ButtonPrimary>
