...
export const GuestNumberField: FC<Props> = ({
  ...
  useEffect(() => {
    ...
    if (a && guestAdultsInputValue === 0) setGuestAdultsInputValue(Number(a))
    if (c && guestChildrenInputValue === 0) setGuestChildrenInputValue(Number(c))
    if (i && guestInfantsInputValue === 0) setGuestInfantsInputValue(Number(i))
  }, [searchParams])
