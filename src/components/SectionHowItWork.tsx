...
const DEMO_DATA: SectionHowItWorkProps['data'] = [
  {
    ...
    desc: 'Hayalindeki turu seç, tarihini belirle ve saniyeler içinde güvenle rezerve et.',
  },
  {
    id: 2,
    img: HIW2img,
    title: 'Onay Bekle',
    desc: 'Talebin acenteye iletilir ve kısa sürede onaylanarak detaylar sana ulaştırılır.',
  },
  {
    id: 3,
    img: HIW3img,
    title: 'Yolculuğun Tadını Çıkar',
    desc: 'Her şey hazır! Şimdi sadece bavulunu topla ve unutulmaz anılar biriktirmeye başla.',
  },
]
...
const SectionHowItWork: FC<SectionHowItWorkProps> = ({
  ...
  return (
    <div className={`nc-SectionHowItWork ${className}`} data-nc-id="SectionHowItWork">
      <Heading isCenter subheading="Üç kolay adımda maceraya atıl">
        {title}
      </Heading>
